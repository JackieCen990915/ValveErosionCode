...
#随机倍数----相对误差大于25%。
# 生成形状为 (25, 1) 的[0, 0.7)范围内的随机浮点数数组
...
regressor= VotingRegressor(estimators=[('xgb', xgb),('lgbm', lgbm)], weights=[0.82921165,0.17174194])
...
'''
MAE: 0.6823584229373587
MSE: 1.7237340415525033
RMSE: 1.3129105230565041
MAPE: 0.029508180494409654
r2_score: 0.9770722461538246
regressor= VotingRegressor(estimators=[('rf', rf),('xgb', xgb),('lgbm', lgbm)], weights=[ 0.57427146,0.49621383,-0.06943444]



----------------------------
MAE: 0.6847621406121094
MSE: 1.7500413585003822
RMSE: 1.3228912874837382
MAPE: 0.029558186766066204
r2_score: 0.9767223269245269
regressor= VotingRegressor(estimators=[('rf', rf),('xgb', xgb)], weights=[0.51578101,0.48525945])



---------------------------
MAE: 0.6308734422640941
MSE: 1.9554725991620654
RMSE: 1.3983821363139852
MAPE: 0.0274169891091946
r2_score: 0.9739898422113031
regressor= VotingRegressor(estimators=[('rf', rf),('lgbm', lgbm)], weights=[ 1.01073577,-0.01022613])


------------------------
MAE: 0.8092675800905141
MSE: 1.9551950632130708
RMSE: 1.3982828981336612
MAPE: 0.03464880956360724
r2_score: 0.9739935337761088
regressor= VotingRegressor(estimators=[('xgb', xgb),('lgbm', lgbm)], weights=[0.82921165,0.17174194])
