...
clf6=MLPRegressor(activation='tanh', alpha=0.001, hidden_layer_sizes=(15,),
             learning_rate_init=0.0001, random_state=90, solver='lbfgs')

# 软投票
estimators=[ ('rf',clf1),( 'lgbm',clf2),( 'xgb',clf3),( 'svr',clf4),( 'dt',clf5),( 'bp',clf6)]
...
'''
MAE: 0.6939239305999992
MSE: 1.5046966657535734
RMSE: 1.226660778599191
MAPE: 0.02958721345078848
r2_score: 0.9799857089702269
'''
