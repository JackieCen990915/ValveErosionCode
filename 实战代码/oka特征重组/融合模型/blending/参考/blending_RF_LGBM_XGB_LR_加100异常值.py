...
meta_model.fit(np.column_stack((predictions_rf, predictions_lgbm,predictions_xgb)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_rf.predict(x_test), base_model_lgbm.predict(x_test),base_model_xgb.predict(x_test))))
...
print('r2_score:', R2)
'''
MAE: 0.684572273605111
MSE: 1.691837694213197
RMSE: 1.3007066134271774
MAPE: 0.029360293407467257
r2_score: 0.9774965062674841
'''
