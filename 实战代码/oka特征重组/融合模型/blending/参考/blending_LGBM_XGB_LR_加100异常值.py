...
meta_model.fit(np.column_stack((predictions_lgbm,predictions_xgb)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_lgbm.predict(x_test),base_model_xgb.predict(x_test))))
...
print('r2_score:', R2)
'''
MAE: 0.8267614498972451
MSE: 1.9250516981052392
RMSE: 1.3874623231299794
MAPE: 0.035290337340690085
r2_score: 0.9743944770995145
'''
