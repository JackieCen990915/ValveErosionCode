...
meta_model.fit(np.column_stack((predictions_rf, predictions_xgb)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_rf.predict(x_test), base_model_xgb.predict(x_test))))
...
print('r2_score:', R2)
'''
MAE: 0.6829388905827045
MSE: 1.7381166315630028
RMSE: 1.3183765135813832
MAPE: 0.029150983092745535
r2_score: 0.9768809402589
'''
