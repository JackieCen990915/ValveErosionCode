...
meta_model.fit(np.column_stack((predictions_rf, predictions_lgbm)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_rf.predict(x_test), base_model_lgbm.predict(x_test))))
...
print('r2_score:', R2)
'''
MAE: 0.626936167878957
MSE: 1.925044594927762
RMSE: 1.3874597633545132
MAPE: 0.02713494510582562
r2_score: 0.974394571580392
'''
