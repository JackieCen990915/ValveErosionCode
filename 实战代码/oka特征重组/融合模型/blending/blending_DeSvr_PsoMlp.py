...
meta_model.fit(np.column_stack((predictions_1, predictions_2)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_1.predict(x_test), base_model_2.predict(x_test))))
...
print('EV:', EV)
'''
MAE: 0.006717778094991609
MSE: 9.940088534841496e-05
RMSE: 0.00996999926521637
MAPE: 282.89628430657274
r2_score: 0.9939984495079306
EV: 0.9939984495079306
'''
