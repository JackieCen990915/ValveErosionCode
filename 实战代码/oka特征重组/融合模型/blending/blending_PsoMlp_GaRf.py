...
meta_model.fit(np.column_stack((predictions_2, predictions_3)), y_test)
...
y_pred = meta_model.predict(np.column_stack((base_model_2.predict(x_test), base_model_3.predict(x_test))))
...
print('EV:', EV)
'''
MAE: 0.01124820527258827
MSE: 0.0002676059383821998
RMSE: 0.016358665544053397
MAPE: 1010.5775031359483
r2_score: 0.9838426936988647
EV: 0.9838426936988647
'''
