...
######################1.导入数据######################
df=pd.read_excel('../../../实战所用数据/0229_冲蚀数据统计_Num_GA_oka.xlsx',sheet_name='Sheet1')
...
'''
MAE: 0.0542302781526736
MSE: 0.006278367746395605
RMSE: 0.07923615176417646
MAPE: 841.64750887386
r2_score: 0.4715921870391243
EV: 0.5305718517942569
'''
