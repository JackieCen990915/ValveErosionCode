...
#A_DE = DE(func=train_rf, n_dim=2, size_pop=200, max_iter=400,prob_mut=0.7,lb=[1,1], ub=[15,11])

#A_DE = DE(func=train_rf, n_dim=2, size_pop=50, max_iter=50,prob_mut=0.3,lb=[10,1], ub=[100,20])
#A_DE = DE(func=train_rf, n_dim=2, size_pop=50, max_iter=50,prob_mut=0.5,lb=[10,1], ub=[100,20])
#A_DE = DE(func=train_rf, n_dim=2, size_pop=200, max_iter=400,prob_mut=0.5,lb=[1,1], ub=[100,20])
#A_DE = DE(func=train_rf, n_dim=4, size_pop=200, max_iter=400,prob_mut=0.7,lb=[1,1,1,2], ub=[100,20,20,20])
A_DE = DE(func=train_rf, n_dim=5, size_pop=200, max_iter=400,prob_mut=0.7,lb=[1,1,1,1,2], ub=[100,20,8,20,20])
